...
where obj1 and obj2 are the two objects for which we want to estimate the pmi scores. Intuitively the metric measures the probability of both the objects occurring together as against to both of them appearing individually in the scenes. Here is the pmi scores chart plotted for the 150 objects of the VG-MSDN dataset. 
<center>
